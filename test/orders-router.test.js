  ...
  describe("create method", () => {
    test("creates a new order and assigns id", async () => {
      ...
      const orders = await request(app)
        .get(ATTACHED_PATH)
        .set("Accept", "application/json");
      expect(orders.body.error).toBeUndefined();
      expect(orders.body.data).not.toBeUndefined();
      expect(orders.body.data.find(order => order.deliverTo === expectedDeliverTo)).not.toBeUndefined();
    });
